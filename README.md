...
sweet
## Description
API for a candy store to facilitate order management and simplify the purchasing and delivery process for customers
...
```
$ git clone https://github.com/Nour-Asaid/sweet.git
$ cd sweet
$ npm install
```
...
# وصف المشروع
هذا المشروع لمتجر حلويات لتسهيل إدارة الطلبات , وتبسيط عملية الشراء والتوصيل للعملاء
